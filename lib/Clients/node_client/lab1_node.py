...
def start_nodes():
    ...
    # for node_str in other_node_dictionary.keys():
    #     if check_node_is_running(node_str):
    #         node = cxn.servers[node_str]
    #         for server in other_node_dictionary[node_str]:
    #             start_server(node, server)
    # print "Done."
